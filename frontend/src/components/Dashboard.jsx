        ...
        <div className="pre-analysis-container">
          <div className="control-panel-main">
            ...
            <div className="section-divider">
              <h3>🌡️ Room Conditions & Configuration</h3>
      ...
      <div className="loading-container">
        ...
        <div className="loading-progress">
          <p className="progress-step">
            🤖 Room Agents → 🏢 Building Agents → 🌍 Campus Agent
          </p>
          ...
          <p className="progress-note">
            ...
            {elapsedTime >= 30 &&
              elapsedTime < 60 &&
              "🏗️ Processing building data..."}
            {elapsedTime >= 60 &&
              elapsedTime < 120 &&
              "🌍 Generating campus insights..."}
            {elapsedTime >= 120 && "⏰ Large-scale analysis in progress..."}
          </p>
          <p className="progress-hint">
            No timeout • Waiting for backend completion • Using local
            mistral-small:24b
          </p>
        </div>
      </div>
      ...
      {analysis?.execution_info && (
        <div className="execution-summary-dashboard">
          ...
          <div className="execution-stats-dashboard">
            <span>
              ✓ Analyzed {analysis.execution_info.rooms_analyzed} rooms
            </span>
            <span>
              ✓ Across {analysis.execution_info.buildings_analyzed} buildings
            </span>
            <span>
              ✓ Budget level:{" "}
